...
function print(data) {
  ...
  a = ["name", "access", "address", "budget", "catch", "genre", "open", "station_name", "sub_genre"];
  b = ["店名:", "アクセス:", "住所:", "予算:" ,"キャッチコピー:" , "ジャンル:" , "営業時間:" , "最寄駅:" , "サブジャンル:"];

  for(let i = 0; i<a.length; i=i+1){
  	if(i === 3 || i === 5 || i === 8){
      console.log(b[i] + data.results.shop[0][a[i]].name);
    }else{
  		console.log(b[i] + data.results.shop[0][a[i]]);
  	}
